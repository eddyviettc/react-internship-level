    ...
    return (
        <>
            <div className="home-container">
                ...
                <div>Tự do tùy chỉnh html, css, để có một website nhẹ nhàng, khoa học và đẹp.
                    <br />Commit và đẩy source code lên github public.
                    <br />Triển khai website lên Heroku để demo.
                </div>
                ...
                <div>
                    ...
                    <br />Gửi link Heroku và Github link lại email này
                    <br />Thời gian phản hồi 2 ngày làm việc kể từ ngày nhận được bài thi.
                    <br />Yêu cầu backend (option):
